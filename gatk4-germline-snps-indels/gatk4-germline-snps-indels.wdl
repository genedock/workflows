...
workflow HaplotypeCallerGvcf_GATK4 {
  input {
    File input_bam = "public:/demo-data/GATK/broad-public-datasets/NA12878/NA12878.cram"
    File input_bam_index = "public:/demo-data/GATK/broad-public-datasets/NA12878/NA12878.cram.crai"
    File ref_dict = "public:/demo-data/GATK/gcp-public-data--broad-references/hg38/v0/Homo_sapiens_assembly38.dict"
    File ref_fasta = "public:/demo-data/GATK/gcp-public-data--broad-references/hg38/v0/Homo_sapiens_assembly38.fasta"
    File ref_fasta_index = "public:/demo-data/GATK/gcp-public-data--broad-references/hg38/v0/Homo_sapiens_assembly38.fasta.fai"
    File scattered_calling_intervals_list = "public:/demo-data/GATK/gatk-test-data/intervals/hg38_wgs_scattered_calling_intervals_gd.txt"

    Boolean make_gvcf = true
    Boolean make_bamout = false
    String gatk_docker = "genedockdx/gatk:4.2.0.0"
    String gatk_path = "/gatk/gatk"
    String gitc_docker = "genedockdx/genomes-in-the-cloud:2.4.7-1603303710"
