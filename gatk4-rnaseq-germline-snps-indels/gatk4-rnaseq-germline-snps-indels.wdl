...
workflow RNAseq {
    ...
    String gatk4_docker = select_first([gatk4_docker_override, "genedockdx/gatk:latest"])
...
task StarGenerateReferences {
    ...
    Int? read_length
    ## Should this be an input, or should this always be determined by reading the first line of a fastq input
